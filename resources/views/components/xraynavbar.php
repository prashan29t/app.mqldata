...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <!-- Topbar Heading -->
    <a href="/dashboard" class="btn btn-primary btn-icon-split float-right d-none d-md-block">
        <span class="icon text-white-50"><i class="fas fa-fw fa-tachometer-alt"></i></span>
        <span class="text">Go to Dashboard</span>
    </a>
    <h1 class="h5 mb-0 p-2 text-gray-800 ml-auto">LinkedIn X-Ray Advanced Search</h1>
